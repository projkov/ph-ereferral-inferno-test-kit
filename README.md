...
The suite is auto-generated from the PH eReferral IG using the [InfernoSuiteGenerator](https://github.com/hl7au/inferno_suite_generator) gem. It covers the following resource groups:

| Resource group | Notes |
|---|---|
| Patient | First-class profile with search tests |
| ServiceRequest | First-class profile with search tests; core referral request resource |
| Task | First-class profile with search tests; referral workflow state tracking |
| Encounter | Encounter context at the initiating facility |
| Condition | Diagnoses and clinical conditions supporting the referral |
| Observation | Vital signs and clinical measurements |
| Procedure | Procedures performed prior to or during the referral encounter |
| Provenance | Audit trail for referral actions |
| Organization | Initiating and receiving health facilities (NHFR-registered) |
| Practitioner | Referring and receiving practitioners |
| PractitionerRole | Practitioner–facility linkage |
...
lib/
  ph_ereferral_test_kit.rb         # main kit entry point
  ph_ereferral_test_kit/
    version.rb                     # gem version
    igs/                           # IG .tgz packages
    generated/v0.1.0/              # auto-generated tests (do not edit)
...
1. Place the updated IG package at `lib/ph_ereferral_test_kit/igs/<version>.tgz`
