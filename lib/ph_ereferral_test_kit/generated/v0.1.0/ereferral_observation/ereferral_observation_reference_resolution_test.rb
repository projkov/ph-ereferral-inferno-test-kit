...
module PHeReferralTestKit
  module PHeReferralV010
    class EreferralObservationReferenceResolutionTest < Inferno::Test
      ...
      description %(
        ...
        can be accessed by the test client, and conforms to corresponding PH eReferral profile.
      ...
      id :ph_ereferral_v010_ereferral_observation_reference_resolution_test
