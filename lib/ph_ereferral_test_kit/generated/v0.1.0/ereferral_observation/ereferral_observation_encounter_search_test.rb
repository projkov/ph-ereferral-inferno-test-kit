...
module PHeReferralTestKit
  module PHeReferralV010
    class EreferralObservationEncounterSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(MAY) Server returns valid results for Observation search by encounter'
      description %(
...
[PH eReferral Server CapabilityStatement](https://build.fhir.org/ig/niccoreyes/ph-ereferral/branches/main/en/CapabilityStatement/ph-ereferral-server)
      ...
      id :ph_ereferral_v010_ereferral_observation_encounter_search_test
      optional
