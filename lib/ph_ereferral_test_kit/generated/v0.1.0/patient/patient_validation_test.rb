...
module PHeReferralTestKit
  module PHeReferralV010
    class PatientValidationTest < Inferno::Test
      ...
      id :ph_ereferral_v010_patient_validation_test
      title 'Patient resources returned during previous tests conform to the ERefPatient'
      description %(
This test verifies resources returned from the first search conform to
the [ERefPatient](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-patient).
