...
module PHeReferralTestKit
  module PHeReferralV010
    class EncounterGroup < Inferno::TestGroup
      title 'ERefEncounter Tests'
      short_description 'Verify support for the server capabilities required by the ERefEncounter.'
      description %(
  # Background

The PH eReferral ERefEncounter sequence verifies that the system under test is
able to provide correct responses for Encounter queries. These queries
must contain resources conforming to the ERefEncounter as
...
the [ERefEncounter](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-encounter). Each element is checked against
...
read succeeds.
      ...
      id :ph_ereferral_v010_encounter
      run_as_group
      ...
      test from: :ph_ereferral_v010_encounter_patient_search_test
      test from: :ph_ereferral_v010_encounter_status_search_test
      test from: :ph_ereferral_v010_encounter_date_search_test
      test from: :ph_ereferral_v010_encounter_class_search_test
      test from: :ph_ereferral_v010_encounter_read_test
      test from: :ph_ereferral_v010_encounter_validation_test
      test from: :ph_ereferral_v010_encounter_must_support_test
      test from: :ph_ereferral_v010_encounter_reference_resolution_test
    end
  end
end
