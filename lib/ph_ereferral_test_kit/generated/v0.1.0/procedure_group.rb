...
module PHeReferralTestKit
  module PHeReferralV010
    class ProcedureGroup < Inferno::TestGroup
      title 'EReferral Procedure Tests'
      short_description 'Verify support for the server capabilities required by the EReferral Procedure.'
      description %(
  # Background

The PH eReferral EReferral Procedure sequence verifies that the system under test is
able to provide correct responses for Procedure queries. These queries
must contain resources conforming to the EReferral Procedure as
...
the [EReferral Procedure](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-procedure). Each element is checked against
...
read succeeds.
      ...
      id :ph_ereferral_v010_procedure
      run_as_group
      ...
      test from: :ph_ereferral_v010_procedure_patient_search_test
      test from: :ph_ereferral_v010_procedure_code_search_test
      test from: :ph_ereferral_v010_procedure_status_search_test
      test from: :ph_ereferral_v010_procedure_encounter_search_test
      test from: :ph_ereferral_v010_procedure_date_search_test
      test from: :ph_ereferral_v010_procedure_read_test
      test from: :ph_ereferral_v010_procedure_validation_test
      test from: :ph_ereferral_v010_procedure_must_support_test
      test from: :ph_ereferral_v010_procedure_reference_resolution_test
    end
  end
end
