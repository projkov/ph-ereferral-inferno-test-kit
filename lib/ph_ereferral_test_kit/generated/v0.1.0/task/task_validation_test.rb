...
module PHeReferralTestKit
  module PHeReferralV010
    class TaskValidationTest < Inferno::Test
      ...
      id :ph_ereferral_v010_task_validation_test
      title 'Task resources returned during previous tests conform to the EReferral Task'
      description %(
This test verifies resources returned from the first search conform to
the [EReferral Task](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-task).
