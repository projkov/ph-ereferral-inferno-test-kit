...
module PHeReferralTestKit
  module PHeReferralV010
    class TaskRequesterSearchTest < Inferno::Test
      include InfernoSuiteGenerator::SearchTest

      title '(SHOULD) Server returns valid results for Task search by requester'
      description %(
A server SHOULD support searching by
requester on the Task resource. This test
...
[PH eReferral Server CapabilityStatement](https://build.fhir.org/ig/niccoreyes/ph-ereferral/branches/main/en/CapabilityStatement/ph-ereferral-server)
      ...
      id :ph_ereferral_v010_task_requester_search_test
      optional
