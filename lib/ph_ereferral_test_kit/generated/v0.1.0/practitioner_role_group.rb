...
module PHeReferralTestKit
  module PHeReferralV010
    class PractitionerRoleGroup < Inferno::TestGroup
      ...
      short_description 'Verify support for the server capabilities required by the PH eReferral PractitionerRole.'
      description %(
  # Background

The PH eReferral PractitionerRole sequence verifies that the system under test is
able to provide correct responses for PractitionerRole queries. These queries
must contain resources conforming to the PH eReferral PractitionerRole as
...
the [PH eReferral PractitionerRole](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-practitioner-role). Each element is checked against
...
read succeeds.
      ...
      id :ph_ereferral_v010_practitioner_role
      run_as_group
      ...
      test from: :ph_ereferral_v010_practitioner_role_read_test
      test from: :ph_ereferral_v010_practitioner_role_identifier_search_test
      test from: :ph_ereferral_v010_practitioner_role_practitioner_search_test
      test from: :ph_ereferral_v010_practitioner_role_organization_search_test
      test from: :ph_ereferral_v010_practitioner_role_role_search_test
      test from: :ph_ereferral_v010_practitioner_role_validation_test
      test from: :ph_ereferral_v010_practitioner_role_must_support_test
      test from: :ph_ereferral_v010_practitioner_role_reference_resolution_test
    end
  end
end
