...
module PHeReferralTestKit
  module PHeReferralV010
    class ProvenanceGroup < Inferno::TestGroup
      title 'EReferral Provenance Tests'
      short_description 'Verify support for the server capabilities required by the EReferral Provenance.'
      description %(
  # Background

The PH eReferral EReferral Provenance sequence verifies that the system under test is
able to provide correct responses for Provenance queries. These queries
must contain resources conforming to the EReferral Provenance as
...
the [EReferral Provenance](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-provenance). Each element is checked against
...
read succeeds.
      ...
      id :ph_ereferral_v010_provenance
      run_as_group
      ...
      test from: :ph_ereferral_v010_provenance_must_support_test
      test from: :ph_ereferral_v010_provenance_reference_resolution_test
    end
  end
end
