...
module PHeReferralTestKit
  module PHeReferralV010
    class PatientGroup < Inferno::TestGroup
      title 'ERefPatient Tests'
      short_description 'Verify support for the server capabilities required by the ERefPatient.'
      description %(
  # Background

The PH eReferral ERefPatient sequence verifies that the system under test is
able to provide correct responses for Patient queries. These queries
must contain resources conforming to the ERefPatient as
...
the [ERefPatient](https://fhir.doh.gov.ph/pheref/StructureDefinition/ereferral-patient). Each element is checked against
...
read succeeds.
      ...
      test from: :ph_ereferral_v010_patient_gender_search_test
      test from: :ph_ereferral_v010_patient_read_test
      test from: :ph_ereferral_v010_patient_validation_test
      test from: :ph_ereferral_v010_patient_must_support_test
    end
  end
end
